...
#Code by T.me/T_A_Tl
rep_dev = (7728230165,7728230165)
rep_dev = (7728230165,7728230165)
baqir = (7728230165, 7728230165)
...
# الـرتب الوهميـه & فارات الكليشـه & البريميـوم & عـدد الرسـائل & التفاعـل = كتـابـة الكـود - الاسطوره عاشق الصمت @T_A_Tl / خاصـه بسـورس - جـاكثون @yamenthon فقـط
...
################# Dev yamenthon #################
    if user_id in baqir: #Code by T.me/T_A_Tl
        ...
        rotbat = "العضـو 𓅫"
################# Dev yamenthon ################# 
    REP_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت جـاكثون"  #Code by T.me/T_A_Tl
    REPM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ " #Code by T.me/T_A_Tl
    REPF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄┄─ 𝐉𝐀𝐂𝐊𝐀𝐓𝐇𝐎𝐍 ─┄┄─┄─⋆" #Code by T.me/T_A_Tl
