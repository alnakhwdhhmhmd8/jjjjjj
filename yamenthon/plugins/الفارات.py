...
BaqirVP_cmd = (
    "𓆩 [𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/xvwwvl) 𓆪\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـه مـن القنـاة @Jakathon\n\n\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @Jakathon\n\n"
    ...
    "\n𓆩 [𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/Jakathon) 𓆪"
)


BaqirTZ_cmd = (
    "𓆩 [𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الوقت](t.me/xvwwvl) 𓆪\n\n"
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await rep.edit("**「❖╎تم حـذف {} بنجـاح ☑️**\n**「❖╎المتغيـر المحـذوف : ↶**\n `{}` \n**「❖╎يتم الان اعـادة تشغيـل بـوت جـاكثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, variable))
...
async def custom_rep(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await rep.edit("**「❖╎الفـار {} موجـود ☑️**\n**「❖╎قيمـة الفـار : ↶**\n `{}` \n\n**「❖╎قنـاة السـورس : @xvwwvl**".format(input_str, variable))
        ...
        if variable is None:
            await rep.edit("**「❖╎فـار ايموجي/رمز الايدي غيـر موجـود ❌**\n**「❖╎لـ اضـافته بالـرد ع الكليشـة من هنا ( @xvwwvl_cklaish ) استخـدم الامـر : ↶**\n `.اضف كليشة الايدي` \n\n**「❖╎قنـاة السـورس : @xvwwvl**")
        else:
            await rep.edit("**「❖╎الفـار {} موجـود ☑️**\n**「❖╎قيمـة الفـار : ↶**\n `{}` \n\n**「❖╎قنـاة السـورس : @xvwwvl**".format(input_str, variable))
...
async def variable(event):
    ...
    rep = await edit_or_reply(event, "**「❖╎جـاري أعـداد المنطقـه الزمنيـه لـ جـاكثون 🌐...**")
    # All Rights Reserved for "Repthon" "باقر"
    ...
    if tiba.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await rep.edit("**「❖╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**「❖╎المتغيـر : ↶**\n `{}` \n\n**「❖╎قنـاة السـورس : @xvwwvl**".format(input_str, vinfo))
