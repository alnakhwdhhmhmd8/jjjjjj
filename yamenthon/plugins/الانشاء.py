...
async def _(event):
    ...
    if type_of_group == "قناه":
        descript = "**「❖╎هـذه القنـاة تم إنشائهـا بواسطـة .. يـــمنثون™**"
    else:
        descript = "**「❖╎هـذا المجمـوعـه تم إنشائهـا بواسطـة .. يـــمنثون™**"
    if type_of_group == "جروب":
        try:
