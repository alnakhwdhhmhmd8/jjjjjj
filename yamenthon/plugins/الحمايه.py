...
from xvwwvl.core.logger import logging
...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍  **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def approve_p_m(event):
    ...
    await edit_or_reply(
        ...
        caption="𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 المسمـوح لهـم ( المقبوليـن )**\n\n**- سـورس جـاكثون ** 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 ",
    )
