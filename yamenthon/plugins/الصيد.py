...
BaqirChecler_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 - اوامـر الصيـد والتشيكـر](t.me/xvwwvl) 𓆪\n\n"
    ...
    try:
        ch = await zq_lo(
            functions.channels.CreateChannelRequest(
                title="「❖ صيـد جـاكثون 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 「❖",
                about="This channel to hunt username by - @xvwwvl",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_message(
                    event.chat_id,
                    "ᯓ 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - صيـد جـاكثون 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Channel ❳\n**•────────────────────•**\n- By ❲ @xvwwvl ❳ ".format(
