...
RepthonWF_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 - اوامـر الـردود / والتـرحيب](t.me/xvwwvl) 𓆪\n\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍](t.me/xvwwvl) 𓆪"
)


# Copyright (C) 2022 xvwwvl 
...
async def on_snip_list(event):
    ...
    for filt in filters:
        if OUT_STR == "** ❈╎لاتوجـد ردود محفوظـه في هـذه الدردشـه ༗**":
            OUT_STR = "𓆩 𝗦𝗼𝘂𝗿𝗰𝗲 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 - قائمـة الـردود 𓆪\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n"
        OUT_STR += "👉 `{}`\n".format(filt.keyword)
    await edit_or_reply(
        event,
        OUT_STR,
