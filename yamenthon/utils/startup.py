...
LOGS = logging.getLogger("xvwwvl")
cmdhr = Config.COMMAND_HAND_LER
Rep_Vip = (7728230165,7728230165)
Rep_Dev = (7728230165)
rchannel = {"@xvwwvl", "@xvwwvl1", "@xvwwvl", "@xvwwvl", "@xvwwvl"}
...
async def autovars(): #Code by T.me/eaea8a
...
async def autoname(): #Code by T.me/eaea8a
...
async def mybot(): #Code by T.me/eaea8a
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"《البوت المساعد من سورس يـــمنثون| قناة السورس @xvwwvl | مطور السورس @eaea8a 》 ")
            await asyncio.sleep(3)
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zq_lo.upload_file(file="xvwwvl/baqir/Yemen1.jpg")
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zq_lo.upload_file(file="xvwwvl/baqir/Yemen.jpg")
        _, groupid = await create_supergroup(
...
async def install_externalrepo(repo, branch, cfolder):
    ...
    await load_plugins(folder="xvwwvl", extfolder=cfolder)
