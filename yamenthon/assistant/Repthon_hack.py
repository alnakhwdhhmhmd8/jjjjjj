...
'''
mm = '''
**- عليك الانضمـام في قنـاة السـورس اولاً**  @xvwwvl
'''
...
keyboard = [
  ...
  [
    Button.url("𝐉𝐀𝐂𝐊𝐀𝐓𝐇𝐎𝐍™ 𓅛", "https://t.me/xvwwvl")
    ]
]
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("قنـاة السـورس", "https://t.me/xvwwvl")
        ]
    ]
